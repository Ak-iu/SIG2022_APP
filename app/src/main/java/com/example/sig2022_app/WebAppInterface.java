...
import com.example.sig2022_app.ui.services.ServicesFragment;
...
public class WebAppInterface {
    ...
    @JavascriptInterface
    public void selectDegradation(String message) {
        ((ServicesFragment) fragment).selectDegradation(message);
    }
